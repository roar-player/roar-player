...
<template>
	...
	<footer>
		Version {{ version }}. This project was started by RoR and called <a href="https://player.rhythms-of-resistance.org" target="_blank">RoR Player</a>, see the code <a href="https://github.com/beatboxjs/ror-player" target="_blank">here</a>. Thank you RoR for sharing ❤️
	</footer>
</template>
